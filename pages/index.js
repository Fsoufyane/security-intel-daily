...
const SEED_NEWS = [
  ...
  { title: "Manhattan crypto exec assaulted in home invasion", summary: "A known Bitcoin holder was attacked by masked intruders demanding wallet access.", source: "CoinDesk", category: "Crypto Kidnapping" },
  { title: "Barcelona trader kidnapped, forced to transfer 400K euros", summary: "A Spanish crypto trader was held for three days until transferring funds under duress.", source: "Reuters", category: "Crypto Kidnapping" },
  { title: "Fortinet VPN zero-day exploited before patch", summary: "A critical RCE flaw in enterprise VPN was weaponised for weeks before a fix was released.", source: "SecurityWeek", category: "Corporate Security" },
  { title: "SAP NetWeaver flaw exploited by Chinese APT", summary: "An RCE flaw in SAP software was used in targeted attacks against European manufacturers.", source: "Mandiant", category: "Corporate Security" },
];
...
function NewsCard({ item }) {
  ...
  const generate = async (type) => {
    ...
    const prompts = {
      ...
      blog: "Based on this security news: " + b + "\nFull blog article French then English.\nARTICLE FRANCAIS - TITRE/CHAPEAU/CONTEXTE/ANALYSE/POINTS CLES/CONCLUSION/META/TAGS\nENGLISH ARTICLE - TITLE/INTRO/BACKGROUND/ANALYSIS/KEY TAKEAWAYS/CONCLUSION/META/TAGS\nPlain text only.",
    };
    try {
